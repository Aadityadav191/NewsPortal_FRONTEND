...
const DashboardHeader = () => {
  ...
  const roleConfigs = {
    superadmin: {
      ...
      description:
        "Full oversight of the publication pipeline. You can manage roles, override system configurations, delete articles, and audit all platform activity logs.",
    ...
    admin: {
      ...
      description:
        "Manage system categories, review reported text queues, and moderate submissions across all columns. You hold publishing, editing, and architectural access rights.",
    ...
    author: {
      ...
      description:
        "Draft, edit, and organize your personal news articles. Monitor your view matrix analytics, assign categories, and update your published coverage streams.",
  ...
  const currentConfig = roleConfigs[user?.role] || {
    ...
    description:
      "Welcome to the news portal workflow area. Access tools corresponding to your assigned system roles below.",
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          ...
          <div className="max-w-2xl">
            <div className="flex items-center gap-3 flex-wrap">
              ...
              <span
                className={`px-2.5 py-0.5 text-xs font-bold uppercase tracking-wide border rounded-md ${currentConfig.badgeBg}`}
              >
          ...
          <div className="grid grid-cols-2 gap-3 min-w-70">
            ...
            <div className="bg-white/10 backdrop-blur-md rounded-lg p-3 border border-white/10 flex flex-col justify-between">
              ...
              <span
                className={`text-sm font-bold mt-1 uppercase ${currentConfig.accentText}`}
              >
            ...
            <div className="bg-[#362aa5] backdrop-blur-md rounded-lg p-3 border border-white/10 flex flex-col justify-between col-span-2">
              <div className="flex justify-between items-center text-xs">
                ...
                <span className="font-semibold text-white truncate max-w-37.5">
                  {user?.name}
                </span>
              </div>
            </div>
