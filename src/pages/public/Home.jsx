      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-10">
          ...
          <div className="flex items-center gap-1.5 overflow-x-auto pb-2 md:pb-0 scrollbar-none">
            {categories.map((cat) => (
              <button
                ...
                className={`px-3.5 py-1.5 rounded-full text-xs font-bold transition-all uppercase tracking-wider whitespace-nowrap ${
        ...
        {heroArticle ? (
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-stretch">
            ...
            <div className="lg:col-span-8 group bg-white rounded-3xl border border-slate-200/80 shadow-sm hover:shadow-md transition-all duration-300 overflow-hidden flex flex-col justify-between">
                  ...
                  {heroArticle.approvedBy && (
                    <span className="text-xs text-slate-400 font-medium">
                      ...
                      <strong className="text-slate-600">
                        {heroArticle.approvedBy?.name || heroArticle.approvedBy}
                      </strong>
                    </span>
                  )}
                  <Link
                    to={`/article/${heroArticle.slug}`}
                    className="ml-auto inline-flex items-center gap-1 text-xs font-bold text-blue-600 hover:text-blue-800 transition"
                  >
                    Read Lead Story <ArrowRight className="w-4 h-4" />
                  </Link>
                </div>
              </div>
            </div>
