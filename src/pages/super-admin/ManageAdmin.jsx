    ...
    <div className="max-w-7xl mx-auto space-y-8 p-2 sm:p-4">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {pendingAdmins.map((admin) => {
            ...
            return (
              <div
                key={adminId}
                className="group bg-white rounded-2xl border border-gray-100 shadow-sm hover:shadow-md transition-all duration-200 flex flex-col justify-between p-6"
              >
                <div>
                  {/* Candidate Header */}
                ...
                <div className="space-y-3 pt-2">
                  ...
                  >
                    <Eye className="w-3.5 h-3.5" /> Message Request
                  </button>
      ...
      {selectedAdmin && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-gray-900/50 backdrop-blur-xs">
          <div className="bg-white rounded-3xl max-w-lg w-full overflow-hidden flex flex-col shadow-2xl border border-gray-100 animate-in fade-in zoom-in-95 duration-200">
            {/* Modal Header */}
